...
static const struct usb_string_descriptor prod_desc_en  = USB_STRING_DESC("Nimtronix keyboard");
...
void ioInit(void)
{
    ...
    RCC->AHB2ENR |= RCC_AHB2ENR_GPIOCEN; // GPIOC clock enabled
	...
	GPIOC->PUPDR &= ~GPIO_PUPDR_PUPD13_0; // Pull-down
